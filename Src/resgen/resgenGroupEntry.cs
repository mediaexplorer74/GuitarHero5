...
// Type: com.glu.resgen_content.resgenGroupEntry
...
namespace com.glu.resgen_content
{
  ...
  public class resgenGroupEntry
  {
    private string nameField;
    private string consecutiveField;
    ...
    {
      get => this.consecutiveField;
      set => this.consecutiveField = value;
    }
  }
}
